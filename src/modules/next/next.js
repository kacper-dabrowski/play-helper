...
export const generateNextTemplate = (type, sex, language, name) => {
  switch (type) {
    ...
    case identifiers.nextTemplates.MIGRATION:
      return isPolish(language)
    ...
    case identifiers.nextTemplates.ROAMING:
      return isPolish(language)
    ...
    case identifiers.nextTemplates.QOS:
      return isPolish(language)
    ...
    case identifiers.nextTemplates.NO_RESPONSE:
      return isPolish(language)
    ...
    case identifiers.nextTemplates.END_CONVERSATION:
      return isPolish(language)
...
export const returnSalutationArray = (sex) => {
  if (sex === identifiers.sex.man) {
    return ["Pan", "Pana", "Panu", "Pana", "Panem", "Panu", "Panie"];
  }
  if (sex === identifiers.sex.woman) {
    return ["Pani", "Pani", "Pani", "Panią", "Panią", "Pani", "Pani"];
  }
};

export const isPolish = (language) => language === identifiers.language.polish;

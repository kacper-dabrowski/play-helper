    ...
    return (
        <StyledPlayNextSettings>
            ...
            <PlayNextButton
                ...
                title="Usuń konto"
                onClick={() => onGenerateTemplate(identifiers.nextTemplates.DELETE_ACCOUNT)}
            />
            <PlayNextButton
                active={activeTemplate === identifiers.nextTemplates.NOTIFICATION}
                title="Zgłoszenie"
                onClick={() => onGenerateTemplate(identifiers.nextTemplates.NOTIFICATION)}
            />
            <PlayNextButton
            ...
            <PlayNextButton
                ...
                onClick={() => onGenerateTemplate(identifiers.nextTemplates.NO_RESPONSE)}
            />
            <PlayNextButton
                active={activeTemplate === identifiers.nextTemplates.END_CONVERSATION}
                title="Zakończ rozmowę"
                onClick={() => onGenerateTemplate(identifiers.nextTemplates.END_CONVERSATION)}
            />
            <PlayNextButton
                title="+ Dopytaj"
                onClick={() => addToCurrentTemplate(identifiers.nextNotes.ASK, language)}
            />
            <PlayNextButton
                title="+ Ocena pracy"
                onClick={() => addToCurrentTemplate(identifiers.nextNotes.JOB_EVALUATION, language)}
            />
            <BorderButton
